      ...
      getAllMatches: async () => {
        ...
        try {
          ...
          if (data.summaries && Array.isArray(data.summaries)) {
            ...
            const upcomingMatches = data.summaries.filter(event => 
              event.sport_event_status?.match_status === "not_started" || event.sport_event_status?.status === "not_started"
            );
            setStore({ finishedMatches: finishedMatches, upcomingMatches: upcomingMatches });
          } else {
